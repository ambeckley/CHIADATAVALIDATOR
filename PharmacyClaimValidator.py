...
class PharmacyClaimEnforced(BaseModel):
	...
	pharmacylocationzipcode_5_lds : Optional[str] = Field(None, max_length=5)
	prescribingphysicianzipcode_5_lds : Optional[str] = Field(None, max_length=5)
	...
	dateprescriptionfilledmonth : Optional[str] = Field(None, max_length=2)
	paiddatemonth : Optional[str] = Field(None, max_length=2)
	dateprescriptionwrittenmonth : Optional[str] = Field(None, max_length=2)
	dateserviceapprovedapdate : Optional[int] = None
	dateprescriptionfilled : Optional[int] = None
	paiddate : Optional[int] = None
	dateprescriptionwritten : Optional[int] = None
