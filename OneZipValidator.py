...
class OneZipEnforced(BaseModel):
	...
	memberzipcode_5_lds : Optional[int] = None
...
while index < 2089:
	...
	df = pd.read_csv(filename, sep='*', names=['orgid','chiacarrierspecificuniquememberid','memberzipcode_5_lds','memberstateorprovincelds','calendaryear','submissionyear','submissionmonth'], 
