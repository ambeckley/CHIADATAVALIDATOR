...
class MedicalClaimEnforced(BaseModel):
	...
	serviceproviderzipcode_5_lds : Optional[str] = Field(None, max_length=5)
	submissionmonth : Optional[str] = Field(None, max_length=2)
	incurreddatemonth : Optional[str] = Field(None, max_length=2)
	dateserviceapprovedapdatemonth : Optional[str] = Field(None, max_length=2)
	admissiondatemonth : Optional[str] = Field(None, max_length=2)
	dateofservicefrommonth : Optional[str] = Field(None, max_length=2)
	dateofservicetomonth : Optional[str] = Field(None, max_length=2)
	dischargedatemonth : Optional[str] = Field(None, max_length=2)
	paiddatemonth : Optional[str] = Field(None, max_length=2)
	claimprocessedyearmonth : Optional[str] = Field(None, max_length=2)
	dateserviceapprovedapdate : Optional[int] = None
	admissiondate : Optional[int] = None
	dateofservicefrom : Optional[int] = None
	dateofserviceto : Optional[int] = None
	dischargedate : Optional[int] = None
	paiddate : Optional[int] = None
	claimprocesseddate : Optional[int] = None
